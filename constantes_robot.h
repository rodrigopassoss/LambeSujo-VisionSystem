...
public:
    ...
    void GetandSetconstant();

    int zona_morta_rb1_positiva[2];       //Zona morta referente ao Robô 1
                                 //zona_morta_rb1[0] - Zona morta do motor direito
                                 //zona_morta_rb1[1] - Zona morta do motor esquerdo
    int zona_morta_rb1_negativa[2];


    int zona_morta_rb2_positiva[2];       //Zona morta referente ao Robô 2
                                 //zona_morta_rb2[0] - Zona morta do motor direito
                                 //zona_morta_rb2[1] - Zona morta do motor esquerdo
    int zona_morta_rb2_negativa[2];

    int zona_morta_rb3_positiva[2];      //Zona morta referente ao Robô 3
                                 //zona_morta_rb3[0] - Zona morta do motor direito
                                 //zona_morta_rb3[1] - Zona morta do motor esquerdo
    int zona_morta_rb3_negativa[2];


    double constantes_rb1[8];    //Constantes Referente ao Robô 1
    ...
    double constantes_rb2[8];    //Constantes Referente ao Robô 2
    ...
    double constantes_rb3[8];    //Constantes Referente ao Robô 3
     ...
     *
     * Parâmetros:
     *                  1)rb1[] -> vetor do tipo double de tamanho 4 de forma que possuam valores
     ...
     *
     *                2) rb2[] ->  vetor do tipo double de tamanho 4 de forma que possuam valores
     ...
     *
     *                  3)rb3[] -> vetor do tipo double de tamanho 4 de forma que possuam valores
     ...
     *
     *                4)zona1[] -> vetor de tamanho 2 do tipo int, referente aos valores de zona morta
...
private Q_SLOTS:
    ...
    */
    ...
    void on_robo1_currentIndexChanged(int index);

    void on_robo2_currentIndexChanged(int index);

    void on_robo3_currentIndexChanged(int index);
