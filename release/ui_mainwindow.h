...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 1065, 975));
        ...
        widget->setGeometry(QRect(10, 210, 381, 66));
        gridLayout_70 = new QGridLayout(widget);
        ...
        write_data = new QPushButton(widget);
        ...
        send_data = new QLineEdit(widget);
        ...
        read_data = new QPushButton(widget);
        ...
        receive_data = new QLineEdit(widget);
        ...
        widget1->setGeometry(QRect(10, 50, 251, 93));
        gridLayout_71 = new QGridLayout(widget1);
        ...
        connect_disconnect = new QPushButton(widget1);
        ...
        select_ports = new QComboBox(widget1);
        ...
        refresh_ports = new QPushButton(widget1);
        ...
        MenuColorSpace->setCurrentIndex(2);
