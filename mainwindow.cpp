    ...
    ui(new Ui::MainWindow)
{
    ...
    else
    {
        ...
        //cap.open(0,CAP_V4L2);
        cap.open("razer_%02d.jpg",CAP_IMAGES);   //Testes plot virtual e calibração
        if(!cap.isOpened())
        {
...
MainWindow::~MainWindow()
{
    ...
    set->WriteConfigurationsRobots(con->constantes_rb1,con->constantes_rb2,con->constantes_rb3,con->zona_morta_rb1_positiva,con->zona_morta_rb2_positiva,con->zona_morta_rb3_positiva,"Constantes.xml");
    delete azul;
    delete amarelo;
    delete vermelho;
    delete verde;
